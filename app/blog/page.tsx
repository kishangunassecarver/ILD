      ...
      {lead && (
        ...
        >
          ...
          <div className="flex flex-col justify-center p-6">
            ...
            <h2 className="mt-2 text-xl font-extrabold leading-tight tracking-tight text-ink transition group-hover:text-brand-500 sm:text-2xl">
              {lead.title}
            </h2>
        ...
        {rest.map((post) => (
          <article key={post.slug} className="panel card-hover group flex flex-col overflow-hidden">
            ...
            <div className="flex flex-1 flex-col p-4">
              ...
              <h2 className="mt-1.5 line-clamp-2 text-sm font-bold leading-snug text-ink">
                <Link href={`/blog/${post.slug}`} className="transition hover:text-brand-500">
                  {post.title}
                </Link>
              </h2>
