...
function RailButton({
  ...
  return (
    <button
      ...
      aria-hidden={hidden}
      className={cn(
        "absolute top-1/2 z-10 hidden h-9 w-9 -translate-y-1/2 place-items-center rounded-full border border-line bg-night-700 text-snow shadow-rail transition hover:border-aqua-500/50 hover:text-aqua-600 sm:grid",
